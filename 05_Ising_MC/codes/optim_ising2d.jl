...
function ising2d_mcmc(N::Int64, J::Float64, B::Float64, T::Float64; n_steps::Int64 = 10^7, out_freq::Int64 = 10^4)
...
# Compute M
function getM(spins::Array{Int64,2})
...
# Compute E
function getE(spins::Array{Int64,2}, N::Int64, J::Float64, B::Float64)
